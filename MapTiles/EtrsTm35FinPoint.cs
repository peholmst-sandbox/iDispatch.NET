...
{
    /**
     * <summary>A geographical point using ETRS-TM35FIN coordinates.</summary>
     */
    public readonly struct EtrsTm35FinPoint : IGeoPoint
    {
        ...
        /**
         * <summary>Creates a new point from the given ETRS-89 point.</summary>
         */
        public EtrsTm35FinPoint(Etrs89Point wgs84Point)
        {
            // Convert to radians
            var φ = wgs84Point.Latitude * Math.PI / 180;
            var λ = wgs84Point.Longitude * Math.PI / 180;
            ...
            Y = ConversionParams.A1 * ξ * ConversionParams.k0;
            X = ConversionParams.A1 * η * ConversionParams.k0 + ConversionParams.E0;
        }

        /**
         * <summary>Converts this point to an ETRS-89 point.</summary>
         */
        public Etrs89Point ToEtrs89()
        {
            var ξ = Northing / (ConversionParams.A1 * ConversionParams.k0);
            var η = (Easting - ConversionParams.E0) / (ConversionParams.A1 * ConversionParams.k0);
